...
export function OnDestroyMixin<T extends AbstractConstructorType<object>>(
  base: T,
): CanDestroy & T
export function OnDestroyMixin<T extends ConstructorType<object>>(
  base: T,
): CanDestroy & T {
  return class HasDestroySubject
    extends base
    implements HasDestroySubjectContract
  {
