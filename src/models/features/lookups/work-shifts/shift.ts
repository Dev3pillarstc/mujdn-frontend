...
export default class Shift extends BaseCrudModel<Shift, ShiftService> {
    ...
    buildForm() {
        const { nameAr, nameEn, timeFrom, timeTo, attendanceBuffer, leaveBuffer, isDefaultShift } = this;
        return {
            nameAr: [
                nameAr,
                [
            ...
            timeFrom: [
                timeFrom ? this.timeStringToDate(timeFrom) : null,
                [
                    Validators.required
                ]
            ],
            timeTo: [
                timeTo ? this.timeStringToDate(timeTo) : null,
                [
                    Validators.required
                ]
            ],
