...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, MultiSelect, Accordion, AccordionPanel, AccordionHeader, AccordionContent, TranslatePipe],
...
export class ShiftAssignmentPanelComponent implements OnInit {
  ...
  private initialize(): void {
    ...
    this.filteredEmployees = this.selectedDeptIds.length > 0
  ...
  onDepartmentChange(selectedIds: number[]): void {
    ...
    this.filteredEmployees = selectedIds.length > 0
